 ...
 * 等边三角形
 */
public class TriangleWithCamera extends IGLProgram {
    ...
    public TriangleWithCamera(Context context){
        mContext = context;
    }
    ...
    public void buildProgram() {
        if (mContext != null) {
            mProgram = ShaderUtil.buildProgram(ShaderUtil.readRawTxt(mContext, R.raw.triangle_with_camera_vertex_shader),
                    ShaderUtil.readRawTxt(mContext, R.raw.triangle_with_camera_fragment_shader));
